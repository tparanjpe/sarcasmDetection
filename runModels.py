...
vectypes = ['tf-idf', 'countvec', 'hashingvec']

def setVectorizer(vecType):
    if vecType == 'tf-idf':
        myVectorizer = TfidfVectorizer()
        labelEncoder = preprocessing.LabelEncoder()

    elif vecType == 'countvec':
    ...
    return X_train1, X_test, y_train1, y_test


for type in vectypes:
    X_train1, X_test, y_train1, y_test = setVectorizer(type)
